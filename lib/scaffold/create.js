...
var BASE_PACKAGE = {
  description: 'A full Actinium node build with AcmCore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'acmcore-lib': 'https://github.com/Actinium-project/acmcore-lib.git',
    'acmcore-node': 'https://github.com/Actinium-project/acmcore-node.git'
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/acmcore-node.json', configJSON);
      if (!isGlobal) {
