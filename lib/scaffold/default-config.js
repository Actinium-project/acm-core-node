...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.actinium');
  var defaultConfigFile = path.resolve(defaultPath, './acmcore-node.json');
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            ...
            exec: path.resolve(__dirname, '../../bin/actiniumd')
          }
        }
      }
    };
