...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the actinium database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with AcmCore Node configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `acmcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ acmcore-node add acm-wallet-service');
      console.log('    $ acmcore-node add acm-insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ acmcore-node remove acm-wallet-service');
      console.log('    $ acmcore-node remove acm-insight-api');
      console.log();
    });
